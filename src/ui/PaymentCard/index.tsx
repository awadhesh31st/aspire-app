...
const PaymentCardComponent: FC<PaymentCard> = memo((props) => {
  ...
  return (
    <div
      className="m-0 flex w-full flex-col rounded-lg border-none"
    ...
    >
      ...
      <div className="card-info flex flex-col gap-1 rounded-b-lg rounded-tl-lg bg-brand-green px-4 pt-4">
        <span className="mb-3 flex items-center justify-end">
          <img
            src={props.cardVander}
            alt={props.cardProvider}
            className="h-auto w-16 brightness-0 invert"
          />
        </span>
